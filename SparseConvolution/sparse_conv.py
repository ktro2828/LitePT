...
def _apply_act(
    x: torch.Tensor, act_type: tv.gemm.Activation, act_alpha: float, act_beta: float
):
...
class SparseConvolution(SparseConvolutionBase):
    def _conv_forward(
        ...
        if self.indice_key is not None:
            ...
            if data is not None:
                msg = (
                    "due to limitation of pytorch, "
                    "you must provide same algo to "
                    "layers share same indice key."
                )
                ...
                if self.inverse:
                    ...
                    if self.indice_key is not None and datas is not None:
                        ...
                        try:
                            ...
                            outids, indice_pairs, indice_pair_num, num_act_out = (
                                Fsp_custom.get_indice_pairs(
                                    indices,
                                    batch_size,
                                    spatial_shape,
                                    algo,
                ...
                if self.inverse:
                    ...
                    if self.indice_key is not None and data is not None:
                        ...
                        if self.indice_key is not None:
                            ...
                            msg = (
                                f"your indice key {self.indice_key} "
